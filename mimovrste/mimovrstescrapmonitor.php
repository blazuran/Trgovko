<?php
		...
		scrap ('mimovrste/mmonitor1.txt');
		scrap ('mimovrste/mmonitor2.txt');
		scrap ('mimovrste/mmonitor3.txt');
		scrap ('mimovrste/mmonitor4.txt');
		scrap ('mimovrste/mmonitor5.txt');
		scrap ('mimovrste/mmonitor6.txt');
		scrap ('mimovrste/mmonitor7.txt');
		scrap ('mimovrste/mmonitor8.txt');
		scrap ('mimovrste/mmonitor9.txt');
		scrap ('mimovrste/mmonitor10.txt');
		scrap ('mimovrste/mmonitor11.txt');
		scrap ('mimovrste/mmonitor12.txt');
