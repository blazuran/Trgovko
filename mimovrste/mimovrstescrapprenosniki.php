<?php
		...
		scrap ('mimovrste/mprenosniki1.txt');
		scrap ('mimovrste/mprenosniki2.txt');
		scrap ('mimovrste/mprenosniki3.txt');
		scrap ('mimovrste/mprenosniki4.txt');
		scrap ('mimovrste/mprenosniki5.txt');
		scrap ('mimovrste/mprenosniki6.txt');
		scrap ('mimovrste/mprenosniki7.txt');
		scrap ('mimovrste/mprenosniki8.txt');
		scrap ('mimovrste/mprenosniki9.txt');
		scrap ('mimovrste/mprenosniki10.txt');
		scrap ('mimovrste/mprenosniki11.txt');
		scrap ('mimovrste/mprenosniki12.txt');
		scrap ('mimovrste/mprenosniki13.txt');
