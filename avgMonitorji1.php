...
$html = file_get_html("avg2.txt", true); 
...
$html = file_get_html("avgMonitor2.txt", true); 
...
$html = file_get_html("avgMonitor3.txt", true); 
...
$html = file_get_html("avgMonitor4.txt", true); 
...
$html = file_get_html("avgMonitor5.txt", true); 
