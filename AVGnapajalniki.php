...
$html = file_get_html("NAPAJALNIKI1.txt", true); 
...
foreach($html-> find('div.box') as $izdelek){
	...
	echo 'Opis: ' .$opis. '</br>';
        ...
        $query = mysqli_query($conn, "INSERT INTO Products(Title, ProductURL, Price, DateTime, Description,Rating, Stores_ID, Categories_ID) VALUES('$title', '$linkInsert', $cena, '$date', '$opis', 0, $store_id, (SELECT ID FROM categories WHERE Title = 'Komponente'))");
...
$html = file_get_html("NAPAJALNIKI2.txt", true); 
...
$html = file_get_html("NAPAJALNIKI3.txt", true); 
...
$html = file_get_html("NAPAJALNIKI4.txt", true); 
...
$html = file_get_html("NAPAJALNIKI5.txt", true); 
...
$html = file_get_html("NAPAJALNIKI6.txt", true); 
...
$html = file_get_html("NAPAJALNIKI7.txt", true); 
