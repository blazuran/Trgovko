...
$html = file_get_html("MISKE1.txt", true); 
...
foreach($html-> find('div.box') as $izdelek){
	...
	echo 'Opis: ' .$opis. '</br>';
        ...
        $query = mysqli_query($conn, "INSERT INTO Products(Title, ProductURL, Price, DateTime, Description,Rating, Stores_ID, Categories_ID) VALUES('$title', '$linkInsert', $cena, '$date', '$opis', 0, $store_id, (SELECT ID FROM categories WHERE Title = 'Miske'))");
...
$html = file_get_html("MISKE2.txt", true); 
...
$html = file_get_html("MISKE3.txt", true); 
